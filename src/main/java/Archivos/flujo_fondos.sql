...
(7, 150600, 870000.00, '2025-12-11', 0, 'Pago de Materiales', 1, NULL, 3, NULL),
...
(3, 2520, 289000.00, '2025-12-15', 0, 'Cobro Cliente Perez Juan', NULL, 1, NULL, NULL, 2, NULL),
(4, 3558, 750000.00, '2025-12-17', 0, 'Cobro Deuda 2025', '2025-12-10', 3, NULL, NULL, 2, NULL);
...
CREATE TABLE `flujos_mov` (
  ...
  `id_cheque_tercero` bigint(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
--
ALTER TABLE `flujos_mov`
  MODIFY `id_flujo_mov` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
